...
$string['pluginname'] = 'Hate Speach Analysis';
$string['user'] = 'User: {$a}';
...
$string['td'] = 'True detectet';
$string['fd'] = 'False detectet';
...
$string['messageprovider:revision'] = 'Your post is in rivision state because some Hate was detected';
